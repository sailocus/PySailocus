...
class InputPanel(object):
	...
	def __init__(self, view):
		...
		######################################
		# Droplist to choose pre-defined sails
		######################################
		my_row = 0;
		my_column = 1
		ttk.Label(frameWindow, text="Sail definition...").grid(column=my_column, row=my_row);
		...
		my_row = my_row + 1
		my_column = 1
		self._separator = ttk.Separator(frameWindow, orient="horizontal")
		self._separator.grid(row=my_row, column=1, columnspan=3, sticky="we")
